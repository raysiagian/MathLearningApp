...
class PostTestLevelPage extends StatefulWidget {
  const PostTestLevelPage({
    Key? key,
    required this.level,
  ...
  @override
  _PostTestLevelPageState createState() => _PostTestLevelPageState();
}

class _PostTestLevelPageState extends State<PostTestLevelPage> {
  int index = 0;
  int totalScore = 0;
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 100), // Add spacing between QuestionWidget and QuestionOptionWidget
            Row(
